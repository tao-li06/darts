    ...
    return (
      <>
        ...
        <ReactCardFlip isFlipped={showDetails} style={{width: "1200px"}}>
          <div key="front" className="pannel" style={{height: "1000px", width: "1400px", backgroundClip: "white"}}>
          ...
          <div className="pannel" style={{height: "1000px", width: "1200px", display: "flex", flexDirection: "column", backgroundClip: "white"}} key="back">
            <div style={{display: "flex", width: "100%"}}>
